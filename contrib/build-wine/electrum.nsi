...
;Variables
  ...
  !define PRODUCT_NAME "Electrum Meowcoin"
  !define PRODUCT_WEB_SITE "https://github.com/Electrum-RVN-SIG/electrum-meowcoin"
  !define PRODUCT_PUBLISHER "The Meowcoin Community"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-meowcoin-setup.exe"
...
Section
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe" ""

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe" 0
  ...
  ;WriteRegStr HKCU "Software\Classes\lightning\shell\open\command" "" "$\"$INSTDIR\electrum-meowcoin-${PRODUCT_VERSION}.exe$\" $\"%1$\""
